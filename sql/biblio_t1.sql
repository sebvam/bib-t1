...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-07-2025 a las 02:10:32
...
(22, 'sssss', 'asd', '		   asd', 'a', 0, '1', '11', 1, 'https://aa.com', 'asas   asd', '		   asa', 'a'),
(23, 'sssss', 'asd', '		   asd', 'a', 0, '1', '11', 1, 'https://aa.com', 'asas   asd', '		   asa', 'a'),
(24, 'ffssda', 'asd', '		   asdadsdsa', 'dsaa', 0, '1', '11', 1, 'https://aaaa.com', '		   daasdads', '		   asdasdas', 'sdadsa'),
(25, 'ffssda', 'titulo 1', 'asddd', 'imagen_2025-07-03_202707233.png', 0, '2018-04-01', '2028-12-01', 1, 'https://link.com', '1asadsdsa', 'adasddasdasdas', ''),
(26, 'ffssda', 'asas', 'asassa', '', 0, '2111-02-21', '11212-12-11', 1, 'https://aa.com', 'asasassa', 'saasasas', ''),
(27, 'Deportes', 'ASASAS CARARSA', 'CASASSDASDA', '', 0, '11221-11-11', '11212-12-12', 1, 'https://aaaa.com', 'SDADASASDADS', 'ASDASDASDASD', ''),
(28, 'Musica', 'ayuda', 'adyuda 1', '', 1, '1111-01-01', '2121-02-11', 1, 'https://ayuda.com', 'assaassaassaasasas', 'adasdgasdkbsdaghjasdbg', ''),
(29, 'Ayuda', 'ayudadadasdasd', 'asdasdsdad', '', 2, '', '', 1, 'https://ayuda.com', 'asdasdads', 'asdadsasd', '');
...
--
-- Estructura de tabla para la tabla `libros_imp`
--

CREATE TABLE `libros_imp` (
  `id_libro` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `libros_imp`
--

INSERT INTO `libros_imp` (`id_libro`, `titulo`, `autor`, `edicion`, `anio`, `area`, `ejemplares`) VALUES
(1, 'asd', 'asd', '1', '2200', 'assasa', 122);
...
--
-- Estructura de tabla para la tabla `prestamos_imp`
--

CREATE TABLE `prestamos_imp` (
...
--
-- Volcado de datos para la tabla `prestamos_imp`
--

INSERT INTO `prestamos_imp` (`id_prestamo`, `id_libro`, `id_socio`, `fecha_prestamo`, `fecha_devolucion`, `devuelto`) VALUES
(1, 1, 155, '2025-07-04', NULL, 0);
...
--
-- Indices de la tabla `libros_imp`
--
ALTER TABLE `libros_imp`
  ADD PRIMARY KEY (`id_libro`);
...
--
-- Indices de la tabla `prestamos_imp`
--
ALTER TABLE `prestamos_imp`
...
--
ALTER TABLE `carteles`
  MODIFY `id_cartel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
-- AUTO_INCREMENT de la tabla `libros_imp`
--
ALTER TABLE `libros_imp`
...
--
-- AUTO_INCREMENT de la tabla `prestamos_imp`
--
ALTER TABLE `prestamos_imp`
...
--
-- Filtros para la tabla `prestamos_imp`
--
ALTER TABLE `prestamos_imp`
  ADD CONSTRAINT `prestamos_imp_ibfk_1` FOREIGN KEY (`id_libro`) REFERENCES `libros_imp` (`id_libro`),
  ADD CONSTRAINT `prestamos_imp_ibfk_2` FOREIGN KEY (`id_socio`) REFERENCES `personas` (`id`);
COMMIT;
